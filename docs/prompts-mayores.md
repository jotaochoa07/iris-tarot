# Prompts de los 22 Arcanos Mayores
...
Must include: a bundle hanging from the staff, BEHIND him, a small animal BEHIND him, tearing at his clothes at leg height, bells.
SPATIAL RELATIONS — these are not optional details, they are what the card means. Every one of them must be visible in the drawing:
  · the fool —MOVES TOWARD→ the RIGHT edge of the card
  · the fool —HOLDS→ a staff resting on his shoulder
  · the bundle —HANGS FROM→ that staff, BEHIND his head
  · the fool —HOLDS→ a second, shorter stick
  · the second stick —TOUCHES→ the ground, AHEAD of him
  · the animal —BEHIND→ the fool
  · the animal —TUGS AT→ his clothes, at leg height
...
SPATIAL RELATIONS — these are not optional details, they are what the card means. Every one of them must be visible in the drawing:
  · the popess —HOLDS→ ONE single open book, by both its edges
...
SPATIAL RELATIONS — these are not optional details, they are what the card means. Every one of them must be visible in the drawing:
  · the emperor —HOLDS→ a sceptre with orb and cross, held up
...
SPATIAL RELATIONS — these are not optional details, they are what the card means. Every one of them must be visible in the drawing:
  · the two smaller figures —BELOW→ the pope
...
SPATIAL RELATIONS — these are not optional details, they are what the card means. Every one of them must be visible in the drawing:
  · the hermit —MOVES TOWARD→ the LEFT edge of the card
  · the hermit —HOLDS→ a lit lantern
...
SPATIAL RELATIONS — these are not optional details, they are what the card means. Every one of them must be visible in the drawing:
  ...
  · the rope —HANGS FROM→ the crossbeam
...
SPATIAL RELATIONS — these are not optional details, they are what the card means. Every one of them must be visible in the drawing:
  ...
  · the woman —POURS ONTO→ the earth, from the other jug
...
SPATIAL RELATIONS — these are not optional details, they are what the card means. Every one of them must be visible in the drawing:
  · the two animals —LOOKS AT→ the moon, upward
...
SPATIAL RELATIONS — these are not optional details, they are what the card means. Every one of them must be visible in the drawing:
  ...
  · the central figure —BACK TURNED TO→ the person looking at the card
